...
const projects = [
  ...
  },
  {
    ...
    appStoreUrl: '',
    playStoreUrl: '',
    // ?v=2 busts the CDN cache after the placeholder icon was replaced.
    icon: `${ICON('breakpoint')}?v=2`,
  },
  {
    slug: 'dailypaws',
    type: 'app',
  ...
  },
  {
    ...
    title: 'CampusLM',
    description:
      'An AI assistant for navigating Middlebury College — dining menus, events, courses, and campus resources, answered through chat. The web companion to MiddApp, published under the Mooslix studio and hosted on Firebase.',
    url: 'https://middgpt.web.app',
    repositoryUrl: '',
    icon: ICON('campuslm'),
    image: S('campuslm', 1),
    features: [
      'Chat-based assistant for campus resources',
      'Dining menus, events, and course info',
      'Web companion to the MiddApp mobile app',
    ],
