  ...
  return (
    <div className={`bg-dark-900/50 border border-white/10 rounded-lg p-6 hover:border-white/20 transition-all duration-300 ${className}`}>
      ...
      <div className="flex items-start gap-4 mb-6">
        {icon && (
          <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded overflow-clip flex items-center justify-center">
      ...
      {screenshots.length > 0 && (
        <div className="mb-6">
          <h4 className="text-lg font-heading font-semibold text-dark-100 mb-3">Screenshots</h4>
            ...
            {screenshots.map((screenshot, index) => (
              <div key={index} className="flex-shrink-0">
                <img 
                  ...
                  className="w-24 h-auto rounded-lg border border-white/10 hover:border-white/20 transition-colors"
                />
              </div>
            ))}
          </div>
