...
const Apps = () => {
  ...
  return (
    <PageTemplate className="apps-page">
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-4 md:px-16 pt-24 pb-12 md:py-12">
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6 md:mb-8 text-dark-50">Apps</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 pt-8 pb-20 -mt-80 md:mt-0 md:py-20">
        ...
        <div className="grid gap-8 md:gap-12">
          {mobileAppsData.map((app) => (
            <ProjectCardLink key={app.id} project={app} basePath="/apps">
              <MobileDetail
                title={app.title}
